...
*/
UCLASS()
class SIMPLELEAPMOTION_API ULeapBlueprintFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	ULeapBlueprintFunctionLibrary(const FObjectInitializer &ObjectInitializer);
