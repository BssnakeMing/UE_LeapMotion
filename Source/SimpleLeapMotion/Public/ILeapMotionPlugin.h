 ...
 * within this plugin.
 */
class SIMPLELEAPMOTION_API ILeapMotionPlugin : public IInputDeviceModule
{
...
public:
	...
	{
		return FModuleManager::LoadModuleChecked< ILeapMotionPlugin >( "SimpleLeapMotion" );
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded( "SimpleLeapMotion" );
	}
